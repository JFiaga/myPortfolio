...
const Projects: FC = () => {
  return (
    ...
    >
      <div className="max-w-[90rem] w-full flex flex-col space-y-10  items-start px-2 md:px  xl:px-24">
        ...
        <div className=" w-full flex flex-col space-y- md:space-y-10 items-center 2xl:items-end justify-center">

...
<Zoom left cascade>
    ...
    <div className='bg-mainBlack w-[90%] h-[20rem] max-w-[31.25rem] flex flex-col items-center justify-center p-2 gap-4 rounded-md shadow-md shadow-black'>
    <ServicesCard
 ...
 <div className='bg-mainBlack w-[90%] h-[20rem] max-w-[31.25rem] flex flex-col items-center justify-center p-2 gap-4 rounded-md shadow-md shadow-black'>
   <ServicesCard
    ...
    alt='next logo'
    img={nextLogo2}
    minstyle='w-[4.375rem] bg-white rounded-full '

  ...
  return (
    ...
    >
      <div
        className={` hidden xl:block absolute z-[1] w-[600px] h-[300px]  mr-2  bg-mainGreen/30 text-black  top-0 ${
          onView
            ...
            : "translate-x-[50%] "
        } ${reverse ? "right-[50%]" : ""} transition-all duration-500`}
      >
        <div
      ...
      >
        ...
        <div
          className={`flex  flex-col space-y-6  z-[1000] w-full h-full relative  `}
        >
          <a
            href={codeLink}
            className="font-semibold text-lg  text-mainGreen hover:text-white"
          >
            {projectName}
          </a>
          ...
          <div>
            <p
              className={`  w-[98%] font-semibold text-opacityColor text-base text-justify md:text-start`}
            >
